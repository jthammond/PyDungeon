...
Tutorial = {1:  {1: WALL,   2:WALL,         3:WALL,         4:WALL,         5:WALL,         6:WALL,         7:WALL,             8:WALL,         9:WALL}, # 1
            ...
            3:  {1:WALL,    2:'R_HALL',     3:'R_ROOM',     4:'F_GUILD',    5:'I_BAR',      6:'I_HALL',     7:'T_STABLES',      8:WALL,         9:WALL}, # 3
            4:  {1:WALL,    2:'R_TRAIN',    3:'R_GUILD',    4:'ROAD',       5:'T_SQUARE',   6:'ROAD',       7:'ROAD',           8:'T_GATES',    9:WALL}, # 4
