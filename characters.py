...
uijoti = Player(Uijoti().Name, Uijoti().Class, Uijoti().Loc, Uijoti().Lvl, Uijoti().Wield, Uijoti().AC, Uijoti().RM, Uijoti().Status, Uijoti().Spells)
zetaphor = Player(Zetaphor().Name, Zetaphor().Class, Zetaphor().Loc, Zetaphor().Lvl, Zetaphor().Wield, Zetaphor().AC, Zetaphor().RM, Zetaphor().Status, Zetaphor().Spells)